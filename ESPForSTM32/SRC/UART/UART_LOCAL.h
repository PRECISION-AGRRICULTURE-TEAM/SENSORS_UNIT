...
#define UART1 (((volatile UART_t * ) USART1_BASE ))
#define UART2 (((volatile UART_t * ) USART2_BASE ))
#define UART3 (((volatile UART_t * ) USART3_BASE ))
#define UART4 (((volatile UART_t * ) USART4_BASE ))
#define UART5 (((volatile UART_t * ) USART5_BASE ))
